...
# Verifico si se cumple el teorema de Shannon, esto lo hago comparando la longitud media y la entropia de la fuente, estas las calculo con funciones aparte
# en las que utilizo como fuente a la extension N (n=1 siendo la fuente original) teniendo en cuenta como pueden variar H y L.
# H la calculo haciendo la sumatoria de las probabilidades multiplicada por su cantidad de informacion, esto representa la cantidad de informacion promedio de la fuente
# L la calculo haciendo la sumatoria de las probabilidades multiplicada por la longitud individual de cada palabra codigo, representa la cantidad de simbolos codigo por palabra que puede aparecer
# Finalmente compruebo si se cumplen las condiciones del teorema y las muestro por pantalla