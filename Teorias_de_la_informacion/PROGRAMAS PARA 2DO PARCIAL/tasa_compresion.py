...
def calcula_tasa_compresion(mensaje,mensaje_codificado):
    return (len(mensaje))/len(mensaje_codificado)   
...
# Calculo la tasa de compresion, que me indica que tanto vario el tamaño del archivo antes y despues de la compresion
# Para calcularlo simplemente divido la longitud del mensaje original sobre a del mensaje codificado