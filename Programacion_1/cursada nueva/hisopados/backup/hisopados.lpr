...
Writeln('la cantidad de pacientes que tuvieron un IGG superior a ',x,' es de ',incisoa1(x,vecigg,i));
Writeln('la cantidad de pacientes que tuvieron un IGG superior a ',y,' es de ',incisoa2(y,vecigm,i));
